...
public class JSimulatedInfraredDetectorTest extends JUnitSuite {
    ...
    public static void setup() {
        ...
        testKit.spawnStandalone(com.typesafe.config.ConfigFactory.load("JSimulatedInfraredDetectorStandalone.conf"));
    }
